---
sidebar: sidebar
permalink: automation/concept_input_variables_controlling_an_api_request.html
...
In addition to an exact match, other operators are available to return a set of objects over a range of values. ONTAP tools REST API supports the filtering operators shown in the table below.
