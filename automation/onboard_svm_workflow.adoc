...
[.lead]
Use the following API to onboard the storage backends and map the SVM to vCenter locally.  See link:../configure/task_configure_user_role_and_privileges.html[Configure ONTAP user roles and privileges] section for the ONTAP SVM user privileges. 
