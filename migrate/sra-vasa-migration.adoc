...
+
.. In the vSphere Client, go to the *Inventory* > *Storage Providers* section.
.. Right-click the ONTAP tools for VMware vSphere storage provider for versions 9.10, 9.11, 9.12, or 9.13, and choose the option to unregister it.
.. Confirm that the old VASA Provider is unregistered from the vCenter Server.
+
[NOTE] 
