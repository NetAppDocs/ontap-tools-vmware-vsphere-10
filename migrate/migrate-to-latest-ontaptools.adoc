...
. Add the vCenter Server instance that you want to migrate to ONTAP tools for VMware vSphere 10.2 release. See link:../configure/add-vcenter.html[Add and register vCenter Server instances]
