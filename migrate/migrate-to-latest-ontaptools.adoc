...
[NOTE]
Migrating from ONTAP tools for VMware vSphere 9.XX is only required when using VASA Provider and vVols. The NFS and VMFS datastores are discovered during the storage discovery process.
