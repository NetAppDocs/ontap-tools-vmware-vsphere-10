...
. Add ONTAP tools for VMware vSphere storage provider 10.1 to the vCenter Server and link:../configure/registration-process.html[Register VASA Provider to vCenter Server].
