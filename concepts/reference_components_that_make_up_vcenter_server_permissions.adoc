...
a|
All the ONTAP tools and VASA Provider specific tasks require the View Privilege.
a|
...
NetApp OTV Administrator
a|
ONTAP tools and VASA Provider tasks related to storage capability profiles and threshold settings.
|===
