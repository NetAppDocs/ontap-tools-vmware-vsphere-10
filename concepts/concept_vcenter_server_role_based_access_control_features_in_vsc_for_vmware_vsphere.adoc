...
|Users and groups |Users and groups are used in permissions to assign roles from Active Directory (AD). vCenter has its own local users and groups that you can use.
