...
For example, any permission that includes a privilege such as ONTAP tools privilege "Add/Modify/Skip storage systems" must be assigned at the root object level.
