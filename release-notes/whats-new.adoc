...
ONTAP tools for VMware vSphere 10.5 P1 supports vCenter High Availability (HA) configurations with vCenter Server 8.0U3 and 9.0. For more information, see the https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-availability/vcenter-server-high-availability.html[vCenter High Availability documentation^].
