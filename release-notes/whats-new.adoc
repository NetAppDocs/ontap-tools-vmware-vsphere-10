...
This release supports VMFS replication with hierarchical consistency group including SRA and SnapMirror active sync. It supports zero RPO backups to improve data protection and recovery.
