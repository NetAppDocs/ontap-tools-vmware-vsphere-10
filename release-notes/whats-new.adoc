...
ONTAP tools for VMware vSphere 10.5 P1 supports vCenter High Availability (HA) configurations. Learn more about https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-availability/vcenter-server-high-availability.html[vCenter High Availability^].
