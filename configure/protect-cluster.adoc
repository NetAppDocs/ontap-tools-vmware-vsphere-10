...
. Select *Add*.
. In the *Protect cluster* window, during create operation, only delete action is supported. You can delete and add the protection again. During Modify host cluster protection operation, edit option is available. You can edit or delete the relationships using the ellipsis menu options.
