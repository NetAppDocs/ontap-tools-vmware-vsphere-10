...
[NOTE]
NVMe protocol for vVols datastore is available if ONTAP tools is registered with vCenter 8.0 and later, and if the ONTAP version is ONTAP 9.91P3 and later.
