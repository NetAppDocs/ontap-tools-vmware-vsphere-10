...
Refer to https://kb.netapp.com/data-mgmt/OTV/VSC_Kbs/OTV_10_What_is_storage_backend_global_and_local_scope[OTV 10: What is storage backend global and local scope^] for more information on global and local storage backends.
