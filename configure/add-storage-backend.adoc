...
[NOTE]
If you do not want a multitenant workflow, use the vCenter UI to add a storage backend. Use ONTAP tools Manager UI for storage-backend management only for adding the storage backend globally. 
