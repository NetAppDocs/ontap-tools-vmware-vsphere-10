...
. Enter a name for the VASA Provider and provide ONTAP tools for VMware vSphere application user credentials and select *Register*. The username can only contain letters, numbers, and underscores. 
