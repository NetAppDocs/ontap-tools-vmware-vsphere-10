...
* You can create a new volume or consistency group for a protection group and add the datastore to the protection group. The datastore is protected when you add it to the protection group.
