...
.. Configure the SnapMirror relationship. If you select the AutomatedFailoverDuplex policy, set up host proximity and access settings before continuing. For details, see link:../protect/config-proximity.html[Configure proximity and access for datastore protection with ONTAP tools].
[NOTE]
