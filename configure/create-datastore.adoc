...
[NOTE]
* The *Asymmetric* option does not apply to NFS datastore creation.
* When you choose the *Any* option in the platform drop-down, all SVMs in the vCenter are visible.
