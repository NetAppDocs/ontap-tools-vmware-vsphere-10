...
.. Configure the SnapMirror relationship. If you select the Automated Failover Duplex policy, set up host cluster configuration settings before continuing. For details, see link:../protect/config-proximity.html[Configure cluster configuration for datastore protection with ONTAP tools].
[NOTE]
...
// need new message for this scenario from Deekshith or Sriram
