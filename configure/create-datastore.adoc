...
. Under advanced options, you can select *Custom export policy* for the NFS protocol or a custom initiator group name for the iSCSI and FC protocols, but it's not recommended. If you use this option, ensure you run discovery in vCenter for all objects.
[NOTE]
...
. You can select a custom export policy under advanced options, but it's not recommended. If used, ensure you run discovery in vCenter for all objects.
[NOTE]
