...
summary: "Install the NetApp NFS Plug-in for VAAI by using ONTAP tools for VMware vSphere."
---
= Install the NFS VAAI plug-in by using ONTAP tools
:icons: font
:imagesdir: ../media/

[.lead]
The NFS vStorage API for Array Integration (NFS VAAI) plug-in connects VMware vSphere to NFS storage arrays, allowing the storage array to handle certain storage operations instead of ESXi hosts. Use ONTAP tools for VMware vSphere to install the VAAI plug-in.
