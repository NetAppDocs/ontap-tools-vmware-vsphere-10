...
* The Primary Network Identifier (PNID) of the vCenter Server must be included in the SAN details.
* NetApp recommends deploying vCenter Server using its FQDN, with the Subject Alternative Name containing DNS Name=machine_FQDN.
* The PNID and DNS name should be identical and resolvable in DNS.
