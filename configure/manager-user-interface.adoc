...
ONTAP tools for VMware vSphere is a multi-tenant system, which manages multiple vCenter Server instances. ONTAP tools Manager provides more control to ONTAP tools for VMware vSphere administrator over the managed vCenter Server instances and onboarded storage backends. 
