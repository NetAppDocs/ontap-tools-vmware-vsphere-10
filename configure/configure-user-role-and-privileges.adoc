...
[NOTE]
You can create users at cluster level or at SVM level. You can also create users without using the user_roles.json file and if done so, you need to have a minimum set of privileges at SVM level.
