...
.. Select the privileges (Discovery, Create Storage, Modify Storage, Destroy Storage) required for the user, and then select *Add*.
...
|/api/cluster/metrocluster|Read-Only|Retrieves MetroCluster status and configuration details.
|===
