...
. In the *Storage attributes* Pane, you can either create new volumes or use existing volumes. When creating new volume you can enable QoS on the datastore.  
...
. Select *Platform* and *Storage VM* in the Storage pane. You can select *custom Export Policy* in the *Advanced Option* section.
[NOTE]
