...
. From the storage attributes pane, select the *Aggregate* from the drop-down. Select the *Space Reserve*, *Use existing volume*, and *Enable QoS* options as required from the *Advanced options* section and provide the details as required.
