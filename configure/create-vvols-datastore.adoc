...
* For Each Protocol on ONTAP Side, respective services and LIF’s need to be enabled. 
* For NVMe/TCP protocol, perform the following steps to configure ESXi host:
...
For  information on using NVMe/FC protocol with vSphere 8.0, refer to https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html[NVMe-oF Host Configuration for ESXi 8.x with ONTAP].

For more information on using NVMe/FC with vSphere 7.0, refer to https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html[ONTAP NVMe/FC Host Configuration guide] and http://www.netapp.com/us/media/tr-4684.pdf[TR-4684].
