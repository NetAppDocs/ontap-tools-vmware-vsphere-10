...
//10.2 updates
// 10.2 content You cannot create datastores at host level if the  host is part of a host cluster protection in case of uniform configurations.cluster is part
