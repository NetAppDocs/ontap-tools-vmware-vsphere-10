...
sidebar: sidebar
keywords:
summary: 'When you first run ONTAP tools in a vSphere Client, ONTAP tools discover the ESXi hosts, their LUNs and NFS exports, and the NetApp storage systems that own those LUNs and exports.'
---
...
[.lead]
When you first run ONTAP tools in a vSphere Client, ONTAP tools discover the ESXi hosts, their LUNs and NFS exports, and the NetApp storage systems that own those LUNs and exports.
