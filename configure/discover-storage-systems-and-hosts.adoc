...
summary: "Discover ESXi hosts, LUNs, NFS exports, and NetApp storage systems in ONTAP tools at first launch."
---
...
[.lead]
When you launch ONTAP tools for VMware vSphere in the vSphere Client for the first time, it automatically discovers ESXi hosts, their associated LUNs and NFS exports, and the NetApp storage systems that own these resources.
...
. Right-click the required data center and select *NetApp ONTAP tools* > *Update host and storage data*.
+
