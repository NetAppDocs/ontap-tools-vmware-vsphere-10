...
* Ensure you have enabled SRA services in ONTAP tools Manager. For more information, refer the https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere/10/enable-sra.html[Enable SRA] section.
* Ensure you have added vCenter Servers to the ONTATP tools for VMware vSphere appliance. For more information, refer the https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere/10/add-vcenter-server.html[Add vCenter Servers] section.
* Ensure you have added storage backends to ONTAP tools for VMware vSphere. For more information, refer the https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere/10/add-storage-backend.html[Add storage backends] section.
...
[NOTE]
You can set the VASA Provider/SRA username and password in ONTAP tools Manager when enabling these services for the first time. These credentials are needed to register SRA with the VMware Live Site Recovery appliance.
// Github issue 100
