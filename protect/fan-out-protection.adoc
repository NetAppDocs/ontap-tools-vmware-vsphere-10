...
summary: Protect a consistency group with fan-out protection by using synchronous replication on one destination ONTAP cluster and asynchronous replication on a second destination ONTAP cluster.
---
