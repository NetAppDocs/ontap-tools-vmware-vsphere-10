...
summary: "Set up SAN and NAS storage systems before you run SRA workflows in VMware Live Site Recovery."
---
...
[NOTE]
Consistency groups in SRA workflows are supported only with SAN protocols (iSCSI and Fibre Channel) on both ONTAP storage and ASA r2 storage systems.
