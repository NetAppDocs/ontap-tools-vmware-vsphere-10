...
After adding a new datastore to a protected consistency group or volume, perform storage discovery on both the protected and recovery sites. This can be done either on demand or as scheduled, to ensure the new datastore is recognized and protected.
