...
* Small Non-HA configuration contains 12 CPUs and 24 GB RAM.
* Medium Non-HA configuration contains 24 CPUs and 48 GB RAM.
* Large Non-HA configuration contains 36 CPUs and 72 GB RAM.
