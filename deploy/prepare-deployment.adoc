...
. Make sure the host or the resource pool where the OVA is deployed has the minimum resources mentioned in the link:../deploy/prerequisites.html[Prerequisites for deploying ONTAP tools for VMware vSphere] section.
