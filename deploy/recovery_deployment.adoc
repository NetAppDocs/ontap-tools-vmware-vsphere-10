...
---
= How to recover ONTAP tools setup
:icons: font
:imagesdir: ../media/

[.lead]
If you loose your ONTAP tools setup, but have your ONTAP working, you can recover the ONTAP tools setup using the ONTAP.
...
[NOTE]
You cannot recover the ONTAP tools setup if there are issues with vCenter or ONTAP. 
