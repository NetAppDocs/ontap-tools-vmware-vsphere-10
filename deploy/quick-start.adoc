...
[role="quick-margin-para"]
Deploy the ONTAP tools appliance and establish the base services for NFS and VMFS datastores.
...
[role="quick-margin-para"]
Add a vCenter Server instance to register the ONTAP tools vCenter client plug-in and apply the required privileges and roles.
...
[role="quick-margin-para"]
Connect ONTAP storage resources so ONTAP tools can provision and manage datastores.
...
[role="quick-margin-para"]
Use least-privilege access with custom ONTAP roles instead of the default admin account.
[role="quick-margin-list"]
...
[role="quick-margin-para"]
Establish trusted certificate-based communication across multiple vCenter Server instances.
[role="quick-margin-list"]
...
[role="quick-margin-para"]
Set up disaster recovery protection for NFS and VMFS datastores.
Enable the SRA capability in ONTAP tools to configure and protect NFS and VMFS datastores.
...
[role="quick-margin-para"]
Protect ONTAP tools configuration and recover quickly from failures.
