...
[role="quick-margin-para"]
Backup is enabled by default in ONTAP tools for VMware vSphere 10.6 and occurs every 10 minutes. Schedule backups of your ONTAP tools for VMware vSphere setup that you can use to recover the setup in case of a failure.
