...
|rke2 server |9345 |TCP |Internal |RKE2 supervisor API (Restrict to trusted networks).
|kube-apiserver |6443 |TCP |Internal |Kubernetes API server port (Restrict to trusted networks).
