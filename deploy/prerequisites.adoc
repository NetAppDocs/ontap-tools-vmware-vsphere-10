...
|===
[NOTE]
Beginning with ONTAP tools for VMware vSphere 10.4, the virtual machine hardware version changes from 10 to 17.
...
ONTAP tools supports storage backend discovery for up to 200 SVMs and approximately 10,000 LUNs.
// OTVDOC-373 updates
