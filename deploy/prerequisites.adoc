...
The following table provides configuration limits for deploying ONTAP tools for VMware vSphere, covering vVols, VMFS, and NFS datastores. These limits are validated and supported by NetApp. Actual limits may vary depending on your environment and workload. Exceeding these limits may impact performance or supportability and is not recommended.
...
* Cluster protection uses SnapMirror Active Sync, which does not support multi-vCenter deployments.
...
[cols="1,1,2,2,2,2"]
|===
|Deployment |Type |Number of vVols |Number of VMFS and NFS datastores |Number of DR enabled VMFS datastores |Number of hosts |Number of vCenters

|Non-HA |Small (S) |up to 12K |200 |80 |32 |1 or multiple
|Non-HA |Medium (M) |up to 24K |250 |100 |64 |1 or multiple
|High-Availability |Small (S) |up to 24K |350 |200 |64 |1 or multiple
|High-Availability |Medium (M) |up to 50K |600 |200 |128 |1 or multiple
|High-Availability |Large (L) |up to 100K |1024 |250 |256 |1 or multiple
|===
