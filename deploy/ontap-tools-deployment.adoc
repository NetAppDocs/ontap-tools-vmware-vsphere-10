...
sidebar: sidebar
keywords: deployment, ONTAP tools, OVA, vSphere
...
* IPv4 is the node configuration address used to enable diagnostic shell and SSH access for debugging and maintenance.
