...
You can use ONTAP tools with either a Windows vCenter Server or with a VMware vCenter Server VirtualAppliance (vCSA). You must deploy ONTAP tools on a supported vSphere that includes ESXi system.
