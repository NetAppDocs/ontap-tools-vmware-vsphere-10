...
[.lead]
If you lose your ONTAP tools for VMware vSphere setup, you can recover the ONTAP tools setup using the data available in the ONTAP volume data.
...
[NOTE]
You cannot recover your ONTAP tools setup if there are issues with vCenter Server or ONTAP data management software. 
