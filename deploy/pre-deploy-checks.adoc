...
* If you're using the Fibre Channel (FC) for storage connectivity, configure the zoning on your FC switches to connect the ESXi hosts with the SVM's FC LIFs. https://docs.netapp.com/us-en/ontap/peering/create-cluster-relationship-93-later-task.html[Learn about FC and FCoE zoning with ONTAP systems]
