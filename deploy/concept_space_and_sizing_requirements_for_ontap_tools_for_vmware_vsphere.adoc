...
+
The type of ONTAP tools and VASA certificates generated depends on the IP address (IPv4) that you have provided during deployment. While deploying ONTAP tools, if you have not entered any static IP details and your DHCP then the network provides both IPv4 addresses.
