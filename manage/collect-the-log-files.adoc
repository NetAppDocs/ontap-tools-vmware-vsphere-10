...
sidebar: sidebar
keywords:
summary: 'You can collect log files for ONTAP tools for VMware vSphere from the options available in ONTAP tools graphical user interface \(GUI\). Technical support might ask you to collect the log files to help troubleshoot a problem.'
---
...
[NOTE]
The log bundle generated replaces the log bundle that was generated within the last last 3 days or 72 hrs.
