...
summary: 'ONTAP storage view under configure tab of an ONTAP tools provides data related to the datastore and its volume.'
---
...
[.lead]
ONTAP storage view under configure tab of ONTAP tools provides data related to the datastores and their volume. This view provides the storage side view of the datastore.
