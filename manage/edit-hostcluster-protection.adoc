...
You cannot delete all the SnapMirror relationships. When you delete a relationship, respective relationship on ONTAP is also removed.
...
You can not interchange asynchronous and AutomatedFailOverDuplex policy types.
