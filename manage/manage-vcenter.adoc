...
// OTVDOC-342 updates
If the vCenter Server certificate has expired or is expiring within the next 30 days, renew it by following these steps:
...
----
-----BEGIN CERTIFICATE-----
MIIFUzCCA7ugAwIBAgIJANOgLapcl5oSMA0GCSqGSIb3DQEBCwUAMIGJMQwwCgYDVQQDDAN2YzExFDASBgoJkiaJk/IsZAEZFgRkZW1vMRUwEwYKCZImiZPyLGQBGRYF
...
-----END CERTIFICATE-----
----
. Save the certificate in a text file with a `.pem` extension.
. Upload the certificate  and select *Modify*.
