...
+
[NOTE]
After you remove vCenter Server instances, the application no longer maintains them.

When you remove vCenter Server instances in ONTAP tools, ONTAP tools automatically performs the following actions: 
