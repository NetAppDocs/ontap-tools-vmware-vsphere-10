...
[.lead]
Managing virtual machines with ONTAP tools for VMware vSphere involves VMs that reside on vVols datastores. This section describes how ONTAP tools handle common VM operations such as migration, cloning, and snapshots on vVol-based VMs. You should consider several factors when migrating existing virtual machines in your data center.
// OTVDOC-351 updates march26
