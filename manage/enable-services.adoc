...
+
The *Allow import of vVols configuration* option is shown only when the VASA Provider service is enabled. This option enables vVols data migration from ONTAP tools 9.xx to ONTAP tools 10.6.
