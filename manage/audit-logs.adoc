...
[.lead]
Manage audit logging in ONTAP tools for VMware vSphere. Audit logs show who performed an action, what happened, when it occurred, the request source, and whether the action succeeded or failed.
// 10.6 topic
