...
.Prerequisites
Ensure the following conditions are met before you protect the host cluster. If the below prerequisites are not met, Protect Cluster action shows an error and does not proceed with protection creation.
