...
sidebar: sidebar
keywords: remove host cluster protection, unprotect host cluster, ONTAP tools protection settings, VMFS protection removal
summary: "Remove host cluster protection to unprotect associated datastores."
---
