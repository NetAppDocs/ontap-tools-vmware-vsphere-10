...
.. If the VMFS datastore is created on ASA r2 platform and if it is part of the protection, you need to unprotect the datastore before deleting it.
...
.. In case of ASA r2 platform based vVols datastore, the checkbox to delete the backing volumes is not applicable.
