...
* To move them to an unmanaged datastore, refer to [Broadcom Technical Documentation](https://techdocs.broadcom.com/) for migrating virtual machines with Storage vMotion
