...
[.lead]
Uninstalling ONTAP tools for VMware vSphere deletes all the data in the tools, so you must complete these steps to gracefully terminate your deployment and avoid unexpected data loss.
