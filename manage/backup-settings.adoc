...
It is not recommended to disable the backup because it prevents ONTAP tools from maintaining low RPO. Disabling the backup doesn't delete the existing backup files.
