...
[.lead]
If you manage both ONTAP tools VMs and ONTAP storage systems, you need to understand how igroups behave, especially when moving datastores from environments not managed by ONTAP tools to those that are. ONTAP tools for VMware vSphere represents and manages igroups using a nested igroup model, and understanding this model helps you interpret behavior differences between earlier releases and the current implementation.
