...
. Provide the vCenter credentials for the instance where ONTAP tools is deployed.
+
...
You can create a dedicated vCenter user and role with only below listed datastore permissions required for the OVF template deployment:
