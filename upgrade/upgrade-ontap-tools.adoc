...
* ONTAP tools for VMware vSphere 10.2 easy small to ONTAP tools for VMware vSphere 10.3 non-HA small
* ONTAP tools for VMware vSphere 10.2 easy medium to ONTAP tools for VMware vSphere 10.3 non-HA medium
* ONTAP tools for VMware vSphere 10.2 advanced small to ONTAP tools for VMware vSphere 10.3 non-HA small
* ONTAP tools for VMware vSphere 10.2 advanced medium to ONTAP tools for VMware vSphere 10.3 non-HA medium
* ONTAP tools for VMware vSphere 10.2 HA small to ONTAP tools for VMware vSphere 10.3 HA small
* ONTAP tools for VMware vSphere 10.2 HA medium to ONTAP tools for VMware vSphere 10.3 HA medium
* ONTAP tools for VMware vSphere 10.2 HA large to ONTAP tools for VMware vSphere 10.3 HA large
// otv10.3 updates
