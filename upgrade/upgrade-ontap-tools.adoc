...
[NOTE]
To upgrade from ONTAP tools for VMware vSphere 10.0 to 10.3 release, you need to first upgrade to ONTAP tools for VMware vSphere 10.1 and then to 10.3 release.'
