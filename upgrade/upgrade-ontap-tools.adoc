...
[.lead]
You can upgrade from ONTAP tools for VMware vSphere 10.3, 10.4, or 10.5 to 10.6. However, to upgrade from ONTAP tools 10.0, 10.1, or 10.2 to 10.6, you must first upgrade to 10.3 or 10.4 before proceeding to 10.6.
