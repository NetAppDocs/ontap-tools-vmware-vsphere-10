...
** From the ONTAP system manager user interface, search the volume by its name in the search bar, then open that volume by clicking on the name. Go to snapshot and add the snapshot of that volume.
